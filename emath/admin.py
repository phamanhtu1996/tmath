...
class EMathAdminSite(admin.AdminSite):
    site_header = "EMath Admin"
    site_title = 'EMath Admin Site'
    index_title = 'Welcome to English Math'

emath_admin_site = EMathAdminSite(name='emath_admin')
